      ...
      <div className="first mt-3 fixed left-0 bg-black w-[165px] z-10 h-[100vh]">
                    <div className="sidebar flex  items-start flex-col">
                        ...
                        <ul className="flex flex-col gap-6 lg:gap-0">
                            ...
                            <Link href="/Logout">
                            <li
                                className="flex md:justify-start items-center justify-center  md:w-fit   hover:bg-gray-900 hover:cursor-pointer fixed bottom-3 left-0 px-5 py-3 hover:rounded-full">
