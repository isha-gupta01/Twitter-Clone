            ...
            <div className="second bg-black w-[600px] min-h-screen ml-[188px] overflow-y-auto ">
                ...
                <form onSubmit={handleSubmit}>
                    <div className=" flex flex-row m-5 items-center gap-3">
                        <img src="WhatsApp Image 2024-02-19 at 00.43.31_082ab663.jpg" className=" w-8 h-8 rounded-full" />
                ...
                <div className="section-mid-part3   w-full h-auto">
                    ...
                    {data.map((item) => (
                        <div key={item._id} className="flex flex-row m-3 ml-8 gap-5">
                            <img className="w-8 h-8 rounded-full" src={item.profileImage} alt="Profile Pic" />
                            ...
                            <div className="h-[22rem] flex flex-col">
                                ...
                                <img src={item.image} alt="Tweet Image" className="w-[90%] h-[60%] rounded-3xl mt-2" />
                                <ul className="flex flex-row justify-between gap-5 mt-4">
                                    <div className="flex flex-row gap-[3rem]">
                                        ...
                                        <li
                                            className="flex flex-row text-white/50 fill-white/50 hover:fill-red-500 hover:text-red-500 hover:shadow-[0_0_12px_2px_rgba(226, 11, 11)] transition-shadow">
                                            <svg viewBox="0 0 24 24" aria-hidden="true" className="w-4 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-1xvli5t r-1hdv0qi">
                                                <g>
                                                    <path
