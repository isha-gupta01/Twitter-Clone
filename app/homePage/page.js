...
const HomePage = () => {
    return (
        <div className='flex bg-black items-center justify-center min-h-screen'>
            <div className=" rounded-lg w-full flex  h-96">
                <div className="flex">
                    <svg viewBox="0 0 24 24" aria-hidden="true"
                        className="w-[20rem] invert mx-36 h-80 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp r-1nao33i r-16y2uox r-8kz0gk">
                        <g>
                            <path
                ...
                <div className=" flex flex-col justify-center ">
                    <h1 className="font-extrabold text-6xl my-10 text-white">Happening now</h1>
